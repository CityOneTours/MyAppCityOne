...
const packages = [
  ...
  { title: 'Discovery Of Morocco', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 4980, duration: 5, country: 'Morocco', img: 'Morocco-images/Depositphotos_25885511_L.webp', link: 'Morocco-packages-list/Morocco-two.html' },
  { title: 'Kazakhstan Packages', themes: ['Family with kids', 'Luxury', 'Honey Moon'], price: 2499, duration: 5, country: 'Kazakhstan', img: 'Kazakhstan-packages-list/Kazakhstan-images/20241104122907_5.webp', link: 'Kazakhstan-packages-list/Kazakhstan-one.html' },
  ...
  { title: 'Jordan Treasures', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 1500, duration: 5, country: 'Jordan', img: 'Jordan-packages-list/Jordan-images/20240302102151_JordanGal1 (4).webp', link: 'Jordan-packages-list/Jordan-one.html' },
