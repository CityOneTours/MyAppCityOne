...
const packages = [
  ...
  { title: 'Armenia', themes: ['Honey Moon', 'Luxury'], price: 1682, country: 'Armenia', duration: 5, img: 'Armenia-images/1.jpeg', link: 'Armenia-packages-list/Armenia-two.html' },
  ...
  { title: 'Explore Georgia', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 920, duration: 6, country: ' Georgia', img: 'Georgia-images/giorgi-gvilava-ZTTjG9CS0c0-unsplash.jpg', link: 'Georgia-packages-list/Georgia-two.html' },
  ...
  { title: 'Vibrant Thailand', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 2699, duration: 5, country: 'Thailand', img: 'Thailand-images/Depositphotos_175352566_L.jpg', link: 'Thailand-packages-list/Thailand-one.html' },
  ...
  { title: 'Amazing Sri Lanka', themes: ['Family with kids', 'Luxury', 'Honey Moon'], price: 4020, duration: 14, country: 'Sri Lanka', img: 'Srilanka-images/stairs-3215722_1920.jpg', link: 'Srilanka-packages-list/Srilanka-three.html' },
  ...
  { title: 'Sri Lanka', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 1985, duration: 6, country: 'Sri Lanka', img: 'Srilanka-images/dambulla-1024350_1920.jpg', link: 'Srilanka-packages-list/Srilanka-four.html' },
  ...
  { title: 'Kyrgystan', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 3195, duration: 7, country: 'Kyrgystan', img: 'Kyrgyzstan-packages-list/Kyrgyzstan-images/20250428163923_Kyrgyzstannewgallery3.jpg', link: 'kyrgyzstan-packages-list/kyrgyzstan-three.html' },
  ...
  { title: 'Best of Singapore', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 2100, duration: 5, country: 'Singapore', img: 'Singapore-packages-list/Singapore-images/sc1.jpg', link: 'Singapore-packages-list/Singapore-one.html' },
  ...
  { title: 'Prague ', themes: ['Adventure', 'Honey Moon', 'Family with kids'], price: 3460, duration: 4, country: 'Prague', img: 'Prague-packages-list/Prague-images/Depositphotos_147890251_L.jpg', link: 'Prague-packages-list/Prague-one.html' },
  ...
  { title: 'South African Wonders ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 6990, duration: 11, country: 'South african', img: 'Southafrica-packages-list/Southafrica-images/Depositphotos_7343452_L.jpg', link: 'Southafrica-packages-list/Southafrica-one.html' },
  { title: 'Highlights of South Africa ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 4480, duration: 6, country: 'South african', img: 'Southafrica-packages-list/Southafrica-images/Depositphotos_440541168_L.jpg', link: 'Southafrica-packages-list/Southafrica-two.html' },
  { title: 'Jeddah - Bride of the Red Sea ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 3130, duration: 4, country: 'saudi arabia', img: 'Saudi-arabia-packages-list/Saudiarabia-images/20230106040705_Pb_SaudiIti2.jpg', link: 'Saudi-arabia-packages-list/saudiarabia-one.html' },
  { title: 'Tale of Two cities ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 5550, duration: 6, country: 'saudi arabia', img: 'Saudi-arabia-packages-list/Saudiarabia-images/20230107051803_Pb_SaudiRiyadhIti4.jpg', link: 'Saudi-arabia-packages-list/saudiarabia-three.html' },
