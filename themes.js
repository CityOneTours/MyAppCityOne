...
const packages = [
  ...
  { title: 'kenya - Mara Safari', themes: ['Adventure', 'Family With Kids'], price: 2830, duration: 4, country: 'Kenya', img: 'Kenya-images/Depositphotos_294059094_L.webp', link: 'kenya-Packages-list/masai-mara-safari-tour.html' },
  { title: 'Maldives-Package', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 7680, duration: 5, country: 'Maldives', img: 'Maldives-images/maldives-1991877_1920.webp', link: 'maldives-Packages-list/maldives-all-inclusive-package.html' },
  ...
  { title: 'Kazakhstan Packages', themes: ['Family with kids', 'Luxury', 'Honey Moon'], price: 2499, duration: 5, country: 'Kazakhstan', img: 'kazakhstan-packages-list/Kazakhstan-images/20241104122907_5.webp', link: 'kazakhstan-packages-list/almaty-city-tour.html' },
  ...
  { title: 'Jordan Treasures', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 1500, duration: 5, country: 'Jordan', img: 'jordan-packages-list/Jordan-images/20240302102151_JordanGal1 (4).webp', link: 'jordan-packages-list/petra-dead-sea-tour.html' },
  ...
  { title: 'kyrgyzstan', themes: ['Adventure', 'Family with kids', 'Honey Moon'], price: 2070, duration: 4, country: 'Kyrgyzstan', img: 'kyrgyzstan-packages-list/Kyrgyzstan-images/20250428082734_KyrgyzstannewItinerary7.webp', link: 'kyrgyzstan-packages-list/Kyrgyzstan-one.html' },
  ...
  { title: 'India-Eastern Delight', themes: ['Adventure', 'Luxury', 'Family with kids'], price: 1720, duration: 8, country: 'India', img: 'india-packages-list/India-images/Depositphotos_1940059_L.webp', link: 'india-packages-list/delhi-agra-tour.html' },
  { title: 'Gods Own Kerala', themes: ['Adventure', 'Luxury', 'Family with kids'], price: 1620, duration: 9, country: 'India', img: 'india-packages-list/India-images/Depositphotos_45916055_L.webp', link: 'india-packages-list/delhi-agra-jaipur-tour.html' },
  ...
  { title: 'Greece_Athens ', themes: ['Adventure', 'Honey Moon', 'Family with kids'], price: 1840, duration: 4, country: 'Greece', img: 'greece-packages-list/Greece-images/20220620074110_Pb_GreeceIti5.webp', link: 'greece-packages-list/athens-santorini-tour.html' },

  { title: 'Greece_Athens – Mykonos ', themes: ['Adventure', 'Honey Moon', 'Family with kids'], price: 5190, duration: 7, country: 'Greece', img: 'greece-packages-list/Greece-images/20220620062310_Pb_GreeceIti3.webp', link: 'greece-packages-list/athens-mykonos-santorini-tour.html' },
  { title: 'Prague ', themes: ['Adventure', 'Honey Moon', 'Family with kids'], price: 3460, duration: 4, country: 'Prague', img: 'prague-packages-list/Prague-images/Depositphotos_147890251_L.webp', link: 'prague-packages-list/Prague-one.html' },
