...
const packages = [
  ...
  { title: 'Vietnam At Glimpse', themes: ['Honey Moon', 'Adventure', 'Family With Kids'], price: 2699, country: 'Vietnam', duration: 6, country: 'Vietnam', img: 'Vietnam-images/Depositphotos_66882175_L.webp', link: 'vietnam-tour-Packages-List/hanoi-halong-bay-da-nang-ho-chi-minh-tour.html' },
  { title: 'Armenia', themes: ['Honey Moon', 'Luxury'], price: 1682, country: 'Armenia', duration: 5, img: 'Armenia-images/1.webp', link: 'armenia-tours-package-list/yerevan-garni-geghard-tour.html' },
  { title: 'Armenia', themes: ['Honey Moon', 'Luxury', 'Family With Kids'], price: 2500, country: 'Armenia', duration: 7, img: 'Armenia-images/armenia 1.webp', link: 'armenia-tours-package-list/yerevan-dilijan-lake-sevan-tsaghkadzor-tour.html' },
  ...
  { title: 'Amazing Sri Lanka', themes: ['Family with kids', 'Luxury', 'Honey Moon'], price: 4020, duration: 14, country: 'Sri Lanka', img: 'Srilanka-images/stairs-3215722_1920.webp', link: 'srilanka-tour-packages-list/kandy-ella-bentota-tour.html' },
  { title: 'Wonders of Sri Lanka', themes: ['Family with kids', 'Luxury', 'Honey Moon'], price: 2250, duration: 8, country: 'Sri Lanka', img: 'Srilanka-images/sri-lanka-289803_1920.webp', link: 'srilanka-tour-packages-list/colombo-kandy-bentota-tour.html' },
  { title: 'Sri Lanka', themes: ['Adventure', 'Luxury', 'Honey Moon'], price: 1985, duration: 6, country: 'Sri Lanka', img: 'Srilanka-images/dambulla-1024350_1920.webp', link: 'srilanka-tour-packages-list/kandy-nuwara-eliya-bentota-tour.html' },
  ...
  { title: 'Jeddah - Bride of the Red Sea ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 3130, duration: 4, country: 'saudi arabia', img: 'Saudi-tour-packages-list/Saudiarabia-images/20230106040705_Pb_SaudiIti2.webp', link: 'Saudi-tour-packages-list/riyadh-jeddah-tour.html' },
  { title: 'Tale of Two cities ', themes: ['Luxury', 'Honey Moon', 'Family with kids'], price: 5550, duration: 6, country: 'saudi arabia', img: 'Saudi-tour-packages-list/Saudiarabia-images/20230107051803_Pb_SaudiRiyadhIti4.webp', link: 'Saudi-tour-packages-list/riyadh-alula-jeddah-tour.html' },
